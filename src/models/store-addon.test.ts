...
describe('StoreAddon', () => {
    ...
    it('rejects decimal and negative add-on prices', async () => {
        await expect(new StoreAddon({ storeId: '507f1f77bcf86cd799439011', addonId: '507f1f77bcf86cd799439012', priceExtra: 10.5 }).validate()).rejects.toThrow()
        await expect(new StoreAddon({ storeId: '507f1f77bcf86cd799439011', addonId: '507f1f77bcf86cd799439012', priceExtra: -1 }).validate()).rejects.toThrow()
    })
})
