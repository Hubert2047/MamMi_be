...
router.post('/:id/session/open', authenticateToken, authorizationPermissions([Role.Admin, Role.SuperAdmin]), openStoreTableSession)
router.post('/:id/session/extend', authenticateToken, authorizationPermissions([Role.Admin, Role.SuperAdmin]), extendStoreTableSession)
router.post('/:id/session/close', authenticateToken, authorizationPermissions([Role.Admin, Role.SuperAdmin]), closeStoreTableSession)
