...
import { closeStoreTableSession, createStoreTable, extendStoreTableSession, getStoreTables, openStoreTableSession, regenerateAllStoreTableQr, regenerateStoreTableQr, updateStoreTable } from '../controllers/store-table.js'
...
router.patch('/:id', authenticateToken, authorizationPermissions([Role.Admin, Role.SuperAdmin]), updateStoreTable)
