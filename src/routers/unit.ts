...
router.post('/', authenticateToken, authorizationPermissions([Role.SuperAdmin]), createUnit)
router.put('/:id', authenticateToken, authorizationPermissions([Role.SuperAdmin]), updateUnit)
