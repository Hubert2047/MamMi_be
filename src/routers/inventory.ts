...
import { approveInventoryReceipt, createInventoryItem, createInventoryReceipt, deleteInventoryReceipt, getInventoryItems, getInventoryReceipts, updateInventoryItem, updateInventoryReceipt } from '../controllers/inventory.js'
...
router.post('/receipts/:id/approve', authenticateToken, approveInventoryReceipt)
