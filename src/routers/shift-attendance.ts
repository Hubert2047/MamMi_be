...
import { checkIn, checkOut, getAttendances, updateAttendance } from '../controllers/shift-attendance.js'
...
router.put('/:id', authenticateToken, authorizationPermissions([Role.SuperAdmin]), updateAttendance)
