...
import { confirmGuestCart, createGuestCart, createOnlineGuestCart, getGuestCart, getOnlineMenu, getQrMenu, updateGuestCart } from '../controllers/public-order.js'

const router = Router()
router.get('/qr/:token', getQrMenu)
router.post('/qr/:token/carts', createGuestCart)
router.get('/online', getOnlineMenu)
router.post('/online/carts', createOnlineGuestCart)
