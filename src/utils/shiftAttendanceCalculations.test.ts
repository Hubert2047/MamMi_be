...
import { completedHours, isValidSessionRange, sessionMinutes } from './shiftAttendanceCalculations.js'
...
describe('work session calculations', () => {
    ...
    it('sums multiple completed sessions in one workday', () => {
        expect(completedHours([
            { checkIn: new Date('2026-09-02T09:00:00+08:00'), checkOut: new Date('2026-09-02T12:15:00+08:00') },
            { checkIn: new Date('2026-09-02T13:00:00+08:00'), checkOut: new Date('2026-09-02T17:30:00+08:00') },
        ])).toBe(7.75)
    })
