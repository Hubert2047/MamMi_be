...
export const isStoreItemAvailable = (availability: StoreAvailability, now = new Date()) =>
...
export const nextStoreMidnight = (now = new Date(), timeZone = DEFAULT_STORE_TIME_ZONE) => {
